...
*path* - use the value returned by path as-is: so, if the path returns a non-zero value then __content__ will be displayed.
 
*path*__<__*value* - only display __content__ if the value returned from *path* is less
*path*[__>__*value*]\
...
October 2020
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM3NjgzMTU3NiwtNTM5NDg2OTIyXX0=
-->